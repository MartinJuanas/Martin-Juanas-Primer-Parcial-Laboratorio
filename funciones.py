...
def ordenar_lista(lista, orden, clave:str, clave2):
    bandera_swap = True
    while bandera_swap:
        bandera_swap = False
...
def mostrar(lista,key):
    ...
    """
    print(f"|id|  Marca  |             Objeto           | {key}  |")
    for elemento in lista:
        print(f"|{elemento['id']:<1}|{elemento['Marca']:<30}|{elemento['Objeto']:<45} |{elemento[key]:<60}|")
...
def mostrar_lista (lista:list):
    """Genera una serie de prints por cada elemento que contiene la lista.
